...
class ReportGenerator:
            ...
            report.append(
                {
                    ...
                    "utilization_days": total_hours / person.availability_hours_per_day
                    if person.availability_hours_per_day > 0
                    else 0,
                }
            )
    ...
    def generate_resource_utilization_report(self) -> List[Dict[str, Any]]:
        ...
        for resource in resources:
            ...
            active_requirements = [
                tr
                for tr in resource.task_requirements
            ...
            report.append(
                {
                    ...
                    "utilization_percentage": (total_quantity / resource.capacity * 100)
                ...
                schedule_by_date[date_key].append(
                    {
                        ...
                        "assigned_person": task.assigned_person.name
