...
BRANDS: dict[BrandName, BrandConfig] = {
    "plugin": BrandConfig(
        ...
        logo_path="/static/plug-in/img/logo.png",
        favicon_path="/static/plug-in/img/favicon.ico",
    ...
    "mcr": BrandConfig(
        ...
        logo_path="/static/mcr-group/img/logo.png",
        favicon_path="/static/mcr-group/img/favicon.ico",
