...
from task_planner.models import Base, Team, Person, Resource, Task, ResourceType, TaskStatus
...
class TestPersonService:
    ...
    def test_add_skill(self, person_service, resource_service):
        ...
        person = person_service.create_person("Alice", "alice@example.com")
        skill = resource_service.create_resource(
            "Python", ResourceType.SKILL, "Python programming"
        )
...
class TestReportGenerator:
    ...
    def test_generate_person_workload_report(
        self, report_gen, person_service, task_service
    ):
    ...
    def test_generate_resource_utilization_report(
        self, report_gen, resource_service
    ):
